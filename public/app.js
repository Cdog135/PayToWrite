console.log("app.js loaded"); // Confirm script loads

const contractAddress = "0x0e5881001275a96a135b1fcd374c4ee4f80ee489";
const contractABI = [
    {
        "inputs": [],
        "name": "__init__",
    ...
    try {
        ...
        await contract.methods.submitMessage(message)
            ...
            .on('receipt', () => {
                ...
                // Display the message in the middle of the page
                document.getElementById('centerMessage').innerText = message;
                loadMessages();
            })
            .on('error', (error) => {
...
async function loadMessages() {
    try {
        ...
        // Force UI update
        messagesDiv.style.display = 'block'; // Ensure the div is visible
    } catch (error) {
